...
export const KAKAOTALK_SHARE_IMAGE =
  "카카오톡으로 공유할 때 사용되는 대표이미지 URL을 입력해주세요!";

export const WEDDING_DATE = "Ngày 27 Tháng 2 Năm 2024";
export const WEDDING_LOCATION =
  "Tổ Liên Gia 27, Thôn Bàn Mạch, Xã Lý Nhân, Huyện Vĩnh Tường, Tỉnh Vĩnh Phúc";
